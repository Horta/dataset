...
exon_start_end = read.table("annotations/geuvadis/Homo_sapiens.GRCh37.050815.gene_exon_start_end.txt", stringsAsFactors = FALSE)
...
saveRDS(intron_df, "annotations/geuvadis/Homo_sapiens.GRCh38.79.intron_df.rds")
intron_gr = dataFrameToGRanges(intron_df)
export.gff3(intron_gr, "annotations/geuvadis/Homo_sapiens.GRCh38.79.introns.gff3")
...
saveRDS(exon_df, "annotations/geuvadis/Homo_sapiens.GRCh38.79.exon_df.rds")
exon_gr = dataFrameToGRanges(exon_df)
export.gff3(exon_gr, "annotations/geuvadis/Homo_sapiens.GRCh38.79.exons.gff3")
